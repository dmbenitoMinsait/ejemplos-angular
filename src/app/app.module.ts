...
import { LogInterceptor } from './cmp09-http/log.interceptor';
import { AuthInterceptor } from './cmp09-http/interceptores/auth.interceptor';
...
@NgModule({
  ...
  providers: [
    // Para hacer uso de los interceptores hay que asignarles la clase del interceptor al token interceptor.
